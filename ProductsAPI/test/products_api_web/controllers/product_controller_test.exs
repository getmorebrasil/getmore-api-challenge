defmodule ProductsAPIWeb.ProductControllerTest do
  ...
  alias ProductsAPI.Catalog
  alias ProductsAPI.Catalog.Product
  ...
  @invalid_attrs %{productCategory: nil, productImage: nil, productName: nil, productPrice: nil, productStock: nil}
